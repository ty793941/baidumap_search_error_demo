...
class BMFBaseMapState<T extends StatefulWidget> extends State<T> {
  ...
  /// 设置地图参数
  BMFMapOptions initMapOptions2(BMFCoordinate? center) {
    BMFMapOptions mapOptions = BMFMapOptions(
      center: center ?? BMFCoordinate(39.917215, 116.380341),
      zoomLevel: 12,
  ...
  /// 创建地图
  Container generateMap2({BMFCoordinate? center}) {
    ...
    return Container(
      ...
      child: BMFMapWidget(
        onBMFMapCreated: onBMFMapCreated,
        mapOptions: initMapOptions2(center),
      ),
    );
  }
